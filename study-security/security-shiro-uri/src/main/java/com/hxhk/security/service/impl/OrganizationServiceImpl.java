...
public class OrganizationServiceImpl extends BaseServiceImpl<Organization, Long>implements OrganizationService {
	 ...
	 * @see com.hxhk.security.service.OrganizationService#delete(Long)
	 */
	@Override
	@Transactional
	 ...
	 * @param pageInfo
	 * @return  
	 * @see com.hxhk.security.service.OrganizationService#find(Long, PageInfo)
	 */
	@Override
	 ...
	 * @param pageInfo
	 * @return  
	 * @see com.hxhk.security.service.OrganizationService#find(Long, String, PageInfo)
	 */
	@Override

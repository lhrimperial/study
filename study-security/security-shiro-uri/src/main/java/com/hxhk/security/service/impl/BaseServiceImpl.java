...
public class BaseServiceImpl<T, ID extends Serializable> implements BaseService<T, ID> {
	...
	/**   
	 * @param entity  
	 * @see com.hxhk.security.service.BaseService#save(Object)
	 */
	@Transactional
	@Override
	...
	/**   
	 * @param entity  
	 * @see com.hxhk.security.service.BaseService#update(Object)
	 */
	@Transactional
	@Override
	...
	/**   
	 * @param id  
	 * @see com.hxhk.security.service.BaseService#delete(Serializable)
	 */
	@Transactional
	@Override
	 ...
	 * @param id
	 * @return  
	 * @see com.hxhk.security.service.BaseService#get(Serializable)
	 */
	@Override
	public T get(ID id) {
	 ...
	 * @param pageInfo
	 * @return  
	 * @see com.hxhk.security.service.BaseService#findAll(PageInfo)
	 */
	@Override

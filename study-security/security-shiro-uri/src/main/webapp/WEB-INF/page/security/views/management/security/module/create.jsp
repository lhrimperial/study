...
<form method="post" action="<%=basePath %>/management/security/module/create" class="required-validate pageForm" onsubmit="return validateCallback(this, hxhkAjaxDone);">
